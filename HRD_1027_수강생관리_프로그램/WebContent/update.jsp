...
<body>
	...
	sql ="select STUDENT_NO, STUDENT_NAME, STUDENT_ADDR, STUDENT_PHONE, to_char(STUDENT_BIRTH,'yyyy/mm/dd'), STUDENT_EMAIL, STUDENT_ID, STUDENT_PW from STUDENT_TBL_01 where STUDENT_NO = ?";
	...
	<section>
		<h4>수강생 수정</h4>
		<form name="s" action="updatePro.jsp" method="post">
		<input type="hidden" name="STUDENT_NO" value="<%=sno %>">
		<table border="1">
			<tr>
				<th>이름</th>
				<td>
					<input type="text" name="STUDENT_NAME" value="<%=rs.getString(2)%>">
				</td>
			</tr>
			<tr>
				<th>주소</th>
				<td>
					<input type="text" name="STUDENT_ADDR" value="<%=rs.getString(3)%>" size=50>
				</td>
			</tr>
			<tr>
				<th>연락처</th>
				<td>
					<input type="text" name="STUDENT_PHONE" value="<%=rs.getString(4)%>">
				</td>
			</tr>
			<tr>
				<th>생년월일</th>
				<td>
					<input type="text" name="STUDENT_BIRTH" value="<%=rs.getString(5)%>">
				</td>
			</tr>
			<tr>
				<th>메일주소</th>
			...
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" name="STUDENT_ID" value="<%=rs.getString(7)%>">
				</td>
			</tr>
			<tr>
				<th>비밀번호</th>
				<td>
					<input type="text" name="STUDENT_PW" value="<%=rs.getString(8)%>">
				</td>
			</tr>
		</table>
		<div class="inputBox">
